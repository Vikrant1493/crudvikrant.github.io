...
<html>
<head>
	<title>Crud_Application - Update User </title>
...
<div class="container" style="padding-top: 10px;">
	<h3>Update User</h3>
	<hr>
	<form method="post" name="Create User" action="<?php echo base_url().'index.php/user/edit/'. $user['id']; ?>">
	<div class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<input type="text" name="mobile_no" value="<?php echo set_value('mobile_no',$user['mobile_no']) ?>" class="form-control">
